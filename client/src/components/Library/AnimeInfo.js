...
function AnimeInfo(){
    ...
    return (
        <>
            ...
            <h2 className="text-5xl text-black font-bold mt-4 mb-20 px-10"> Synopsis: </h2>
             <p className="text-l text-black  mt-4 mb-20 px-10"> {newData?.anime?.synopsis} </p>
            <h3 className="text-5xl text-black font-bold mt-4 mb-2 px-10"> Total Episodes: </h3> <p className="text-5xl text-black  mt-16 mb-20 ml-4 px-10"> {newData?.anime?.episode_count}</p>
            </div>
