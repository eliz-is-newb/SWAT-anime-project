  ...
  <div class="bg-black lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    ...
    <form onSubmit={handleSubmit} class="p-12 md:p-24">
      <div class="flex items-center text-lg mb-6 md:mb-8">
        ...
        <input type="text" id="username" onChange={(e) => setUsername(e.target.value)} class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username"  value={username}/>
      </div>
      <div class="flex items-center text-lg mb-6 md:mb-8">
        ...
        <input type="password" id="password"  value={password}
          onChange={(e) => setPassword(e.target.value)} class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
      </div>
      <button class="bg-lime-500 font-medium p-2 md:p-4 text-white uppercase w-full" onSubmit={handleSubmit} type="submit">{isLoading ? "Loading..." : "Login"}</button>
      {errors.map((err) => (
