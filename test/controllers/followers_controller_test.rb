...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { followee_id: @follower.followee_id, follower_id: @follower.follower_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { followee_id: @follower.followee_id, follower_id: @follower.follower_id } }
