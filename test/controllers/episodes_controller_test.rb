...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { anime_id: @episode.anime_id, ep_num: @episode.ep_num, link: @episode.link } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { anime_id: @episode.anime_id, ep_num: @episode.ep_num, link: @episode.link } }
